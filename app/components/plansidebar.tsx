...
interface SidebarProps {
    ...
    saveablity?: boolean;
    userIDpage: boolean;
    setPopShare?: (value: boolean) => void;
    tripId?: string;
    visibility?: string;

}

const PlanSideBar = ({sideSelected, setSideSelected, dataJSON, tripDetails, currencySymbol, costDetailsRef, status, routePush, shareability, saveablity, userIDpage, setPopShare, tripId, visibility}:SidebarProps) => {

  const saveButton = useRef<HTMLButtonElement>(null);
  const saveText = useRef<HTMLSpanElement>(null);
async function saveTripVanilla() {
